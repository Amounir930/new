...
export function NewsletterPopup() {
  ...
  const t = {
    en: {
      ...
      subscribedDesc:
        'Thanks for joining our newsletter. Check your email for a welcome discount!',
      title: 'Join Our Newsletter',
      description:
        'Subscribe to get 10% off your first order, plus updates on new arrivals and exclusive deals.',
    ...
    ar: {
      ...
      subscribedDesc:
        'شكرًا لانضمامك إلى نشرتنا الإخبارية. تحقق من بريدك الإلكتروني للحصول على خصم ترحيبي!',
      title: 'انضم إلى نشرتنا الإخبارية',
      description:
        'اشترك للحصول على خصم 10٪ على طلبك الأول، بالإضافة إلى تحديثات حول المنتجات الجديدة والصفقات الحصرية.',
