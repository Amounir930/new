  ...
  const StatusDisplay = () => {
    ...
    const statusInfo = {
      processing: {
        ...
        title: t[language].status_processing,
        description: t[language].desc_processing,
      },
      shipped: {
        icon: <Truck className="h-8 w-8 text-blue-500" />,
        title: t[language].status_shipped,
        description: t[language].desc_shipped,
      },
      delivered: {
        icon: <PackageCheck className="h-8 w-8 text-green-500" />,
        title: t[language].status_delivered,
        description: t[language].desc_delivered,
      },
    };
