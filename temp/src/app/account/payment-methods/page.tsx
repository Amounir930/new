        ...
        <div className="space-y-6">
                    ...
                    <Card key={method.id}>
                        <CardHeader>
                            <CardTitle className="flex justify-between items-start">
                                <span>{method.type} {t[language].cardEnding} {method.last4}</span>
                                {method.isDefault && <span className="text-xs font-normal bg-primary text-primary-foreground rounded-full px-2 py-0.5">{t[language].default}</span>}
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p className="text-muted-foreground">{t[language].expires} {method.expiry}</p>
                        </CardContent>
            ...
            {mockPaymentMethods.length === 0 && (
                <div className="text-center py-16 border-2 border-dashed rounded-lg">
                    ...
                    <p className="text-muted-foreground mt-2">{t[language].noMethodsDesc}</p>
                </div>
            )}
        </div>
    )
