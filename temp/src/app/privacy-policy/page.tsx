...
export default function PrivacyPolicyPage() {
  ...
  const t = {
    en: {
      ...
      welcome: "Welcome to StyleGrove! We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.",
    ...
    ar: {
      ...
      welcome: "مرحبًا بك في ستايل جروف! نحن ملتزمون بحماية خصوصيتك. تشرح سياسة الخصوصية هذه كيف نجمع معلوماتك ونستخدمها ونكشف عنها ونحميها عند زيارتك لموقعنا.",
