...
import { User, ShoppingBag, MapPin, Heart, CreditCard, Star, Bell, LogOut, Wallet, Award, Gift, Undo2 } from 'lucide-react';
...
export default function AccountLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        ...
        { href: '/account/payment-methods', label: t[language].paymentMethods, icon: CreditCard },
        ...
        { href: '/account/notifications', label: t[language].notifications, icon: Bell },
    ];
                        ...
                        {navItems.map((item) => (
                            <Link
                                ...
                                className={cn(
                                    ...
                                    pathname.startsWith(item.href) && (item.href !== '/account' || pathname === '/account') ? "bg-muted text-foreground font-medium" : ""
                                )}
                            >
