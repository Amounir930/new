...
export default function ReferralPage() {
  ...
  const t = {
    en: {
      ...
      subtitle:
        "Share your love for StyleGrove and earn rewards. Give your friends $10 off their first order, and you'll get $10 in points for each successful referral.",
    ...
    ar: {
      ...
      title: 'ادع صديقًا',
      subtitle:
        'شارك حبك لـ StyleGrove واكسب المكافآت. امنح أصدقائك خصمًا بقيمة 10 دولارات على طلبهم الأول، وستحصل على 10 دولارات في شكل نقاط عن كل إحالة ناجحة.',
