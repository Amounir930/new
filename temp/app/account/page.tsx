...
export default function AccountDashboardPage() {
    ...
    return (
        <div className="space-y-8">
            <header>
                <h1 className="text-3xl font-bold tracking-tight">{t[language].welcome}</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-sm text-muted-foreground">{t[language].recentOrdersDesc}</p>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-sm text-muted-foreground">{t[language].loyaltyPointsDesc}</p>
                         <Button asChild variant="link" className="px-0">
            ...
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <Button asChild variant="outline" className="justify-start h-16 text-base">
