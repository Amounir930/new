...
const walletData = {
    balance: 55.20,
    transactions: [
        { id: 1, date: "2024-07-26", type: 'Refund', amount: 24.99, description: 'Order #ORD-12340 refund' },
        { id: 2, date: "2024-07-22", type: 'Top-up', amount: 50.00, description: 'Added funds from Visa **** 4242' },
        { id: 3, date: "2024-07-15", type: 'Purchase', amount: -19.79, description: 'Order #ORD-12343' },
    ]
};
...
export default function WalletPage() {
    ...
    const getTransactionType = (type: string) => {
        if (language === 'ar') {
            switch(type) {
                case 'Refund': return t.ar.refund;
                case 'Top-up': return t.ar.topUpType;
                case 'Purchase': return t.ar.purchase;
            }
        }
        return type;
    };
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-5xl font-bold">{formatCurrency(walletData.balance)}</p>
                </CardContent>
            </Card>
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead className="text-right">{t[language].amount}</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {walletData.transactions.map(tx => (
                                <TableRow key={tx.id}>
                                    ...
                                    <TableCell>
                                       <span className={`font-medium ${tx.type === 'Purchase' ? '' : 'text-green-600'}`}>
