  ...
  return (
    <div className="container py-12 md:py-16">
      ...
      <div className="mt-16 text-center">
        ...
        <p className="mt-2 text-muted-foreground">{t[language].supportTeam}</p>
        <Link
          href="/contact"
          className="mt-4 inline-flex items-center justify-center rounded-md bg-primary px-6 py-3 text-base font-medium text-primary-foreground shadow-sm transition-colors hover:bg-primary/90"
        >
