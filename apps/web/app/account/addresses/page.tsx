...
const mockAddresses = [
    { id: 1, type: 'Shipping', address: '123 Fashion Ave, New York, NY 10001', isDefault: true },
    { id: 2, type: 'Billing', address: '456 Style St, Los Angeles, CA 90001', isDefault: false },
];
        ...
        <div className="space-y-6">
                    ...
                    <Card key={address.id}>
                        <CardHeader>
                            <CardTitle className="flex justify-between items-start">
                                <span>{address.type === 'Shipping' ? t[language].shippingAddress : t[language].billingAddress}</span>
                                {address.isDefault && <span className="text-xs font-normal bg-primary text-primary-foreground rounded-full px-2 py-0.5">{t[language].default}</span>}
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
                        ...
                        <CardFooter className="flex gap-2">
                            ...
                            <Button variant="ghost" className="text-destructive hover:text-destructive">{t[language].remove}</Button>
                        </CardFooter>
                    </Card>
                ))}
            </div>
            ...
            {mockAddresses.length === 0 && (
                <div className="text-center py-16 border-2 border-dashed rounded-lg">
                    ...
                    <p className="text-muted-foreground mt-2">{t[language].noAddressesDesc}</p>
                </div>
            )}
        </div>
    )
