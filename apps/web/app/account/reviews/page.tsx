...
const mockReviews = [
  {
    ...
    date: '2024-07-22',
    review:
      'Absolutely love this jacket! The fit is perfect and the quality is amazing. A staple in my wardrobe now.',
  },
  {
    id: 2,
    ...
    date: '2024-07-18',
    review:
      'Super soft and comfortable. I wish it came in more colors, but the white is a classic. Great value.',
  },
];
...
const mockReviewsAr = [
  {
    id: 1,
    productName: 'جاكيت جينز كلاسيك',
    rating: 5,
    date: '2024-07-22',
    review:
      'أحب هذا الجاكيت تمامًا! المقاس مثالي والجودة مذهلة. قطعة أساسية في خزانة ملابسي الآن.',
  },
  {
    id: 2,
    productName: 'تي شيرت قطن عضوي',
    rating: 4,
    date: '2024-07-18',
    review:
      'ناعم ومريح للغاية. أتمنى لو كان متوفرًا بألوان أكثر، لكن اللون الأبيض كلاسيكي. قيمة رائعة.',
  },
];
