...
import { aiHelpCenterSearch, AiHelpCenterSearchOutput } from '@/ai/flows/ai-help-center-search';
          ...
          {!isLoading && !result && !error && (
            <Card className="flex h-48 items-center justify-center text-center">
              <CardContent className="p-8">
                  <h3 className="text-lg font-medium text-muted-foreground">{t[language].askAQuestion}</h3>
                  <p className="mt-1 text-sm text-muted-foreground">{t[language].example}</p>
              </CardContent>
            </Card>
          )}
        </div>
