...
export default function ReturnsPage() {
  ...
  const t = {
    en: {
      ...
      windowDesc:
        'You can return or exchange any item within 30 days of the delivery date.',
      ...
      step1Desc:
        'Email us at returns@stylegrove.com with your order number and the item(s) you wish to return.',
      step2Title: 'Receive Label',
      step2Desc:
        "We'll send you a prepaid return shipping label and instructions on how to send your item back.",
      step3Title: 'Get Refund or Exchange',
      step3Desc:
        "Once we receive and inspect your return, we'll process your refund or exchange. Refunds are issued to the original payment method.",
    },
    ar: {
      ...
      policyTitle: 'سياستنا',
      policyDesc:
        'نريد أن تكون راضيًا تمامًا عن مشترياتك. إذا لم تكن كذلك، فنحن هنا للمساعدة.',
      windowTitle: 'فترة 30 يومًا',
      windowDesc:
        'يمكنك إرجاع أو استبدال أي منتج في غضون 30 يومًا من تاريخ التسليم.',
      conditionTitle: 'حالة المنتج',
      conditionDesc:
        'يجب إرجاع المنتجات في حالتها الأصلية: غير ملبوسة، وغير مغسولة، مع وجود جميع العلامات الأصلية.',
      howToTitle: 'كيف تبدأ عملية الإرجاع',
      step1Title: 'اتصل بنا',
      step1Desc:
        'راسلنا عبر البريد الإلكتروني على returns@stylegrove.com مع رقم طلبك والمنتج (المنتجات) التي ترغب في إرجاعها.',
      step2Title: 'استلم ملصق الشحن',
      step2Desc:
        'سنرسل لك ملصق شحن إرجاع مدفوع مسبقًا وتعليمات حول كيفية إعادة إرسال منتجك.',
      step3Title: 'احصل على استرداد أو استبدال',
      step3Desc:
        'بمجرد استلامنا وفحص مرتجعك، سنقوم بمعالجة المبلغ المسترد أو الاستبدال. يتم إصدار المبالغ المستردة إلى طريقة الدفع الأصلية.',
    },
  };
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  {t[language].step1Desc.replace('returns@stylegrove.com', '')}
                  <a
                    href="mailto:returns@stylegrove.com"
                    className="text-primary hover:underline"
                  >
                    returns@stylegrove.com
                  </a>
                </p>
              </div>
            </div>
