                ...
                <CardContent className="space-y-4">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">{t[language].emailDesc}</p>
                            <a href="mailto:support@stylegrove.com" className="text-primary hover:underline">support@stylegrove.com</a>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">{t[language].phoneDesc}</p>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">{t[language].officeAddress}</p>
                        </div>
                    </div>
                </CardContent>
            </Card>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <Input placeholder={t[language].yourName} value={name} onChange={(e) => setName(e.target.value)} required />
                    <Input type="email" placeholder={t[language].yourEmail} value={email} onChange={(e) => setEmail(e.target.value)} required />
                </div>
                <Input placeholder={t[language].subject} value={subject} onChange={(e) => setSubject(e.target.value)} required />
                <Textarea placeholder={t[language].yourMessage} rows={6} value={message} onChange={(e) => setMessage(e.target.value)} required />
                <Button type="submit" className="w-full">{t[language].submit}</Button>
              </form>
            </CardContent>
          </Card>
        </div>
