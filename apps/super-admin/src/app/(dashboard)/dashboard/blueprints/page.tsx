    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex items-end justify-between">
        ...
        <div className="flex gap-4">
          ...
          <Button asChild className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl shadow-lg shadow-indigo-500/20 px-6 font-bold">
      ...
      {loading ? (
        ...
        <Card className="bg-slate-900/40 border-white/5 p-20 backdrop-blur-md flex flex-col items-center justify-center text-center">
          ...
          <Button asChild className="mt-8 bg-indigo-600/10 hover:bg-indigo-600/20 text-indigo-400 border border-indigo-500/20 rounded-xl px-8 font-bold">
            <Link href="/dashboard/blueprints/new">
