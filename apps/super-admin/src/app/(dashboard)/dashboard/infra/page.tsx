    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div>
                ...
                <p className="text-slate-500 mt-2">Monitor physical nodes, clusters, and network stability.</p>
            </div>
            <Card className="bg-slate-900/40 border-white/5 p-20 backdrop-blur-md flex flex-col items-center justify-center text-center">
                ...
                <p className="text-slate-500 max-w-sm mt-2">Real-time infrastructure health and Prometheus metrics integration coming soon.</p>
            </Card>
        </div>
    );
}
