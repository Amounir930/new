            ...
            <div className="p-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] uppercase tracking-widest text-slate-500 font-bold">System Governance</p>
                    </div>
                </div>
            </div>
            ...
            <div className="p-6">
                <div className="bg-slate-900/50 rounded-2xl p-4 border border-white/5 backdrop-blur-sm">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">S1-S15 Protocols Active</span>
                    </div>
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 overflow-hidden">
                            ...
                            <p className="text-[10px] text-slate-500 truncate">admin@60sec.shop</p>
                        </div>
                    </div>
                </div>
            </div>
