        ...
        <div className="flex justify-between items-center px-4">
          {[1, 2, 3].map((s) => (
            <div key={s} className="flex items-center gap-2">
              ...
              <span
                className={`text-sm font-medium ${step >= s ? 'text-indigo-600' : 'text-slate-400'}`}
              >
        ...
        {step === 1 && (
          <Card className="border-none shadow-2xl animate-in fade-in slide-in-from-bottom-4 duration-500">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                First, give your store a name and identity.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleIdentitySubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="logo"
                    type="file"
                    className="h-auto p-2 border-dashed border-2"
                  />
                </div>
                <Button
                  type="submit"
          ...
          <div className="animate-in fade-in slide-in-from-right-4 duration-500">
            <header className="text-center mb-8">
              ...
              <p className="text-slate-500">
                Upload your existing products here.
              </p>
            </header>
            <BulkImportUI />
        ...
        {step === 3 && (
          <Card className="border-none shadow-2xl text-center p-8 animate-in zoom-in-95 duration-500">
            ...
            <Button
              ...
              className="mt-8 h-12 px-8 bg-indigo-600 text-lg font-bold"
            >
              Go to Dashboard
            </Button>
          </Card>
