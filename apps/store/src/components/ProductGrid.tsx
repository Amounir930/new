            ...
            {products.map((product) => (
                ...
                >
                    <div className="relative aspect-square mb-4 rounded-2xl overflow-hidden bg-gray-50">
                        ...
                        />
                        <button className="absolute bottom-4 right-4 p-3 bg-blue-600 text-white rounded-2xl shadow-lg transform translate-y-12 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                    ...
                    <div className="space-y-1 px-1">
                        ...
                        <div className="flex items-center justify-between pt-2">
                            <span className="text-xl font-black text-gray-900">{product.price} <span className="text-sm font-medium text-gray-500 lowercase">{product.currency}</span></span>
                            <div className="flex bg-yellow-50 px-2 py-0.5 rounded-lg">
                                ...
                                <span className="text-[10px] font-bold text-yellow-700 ml-1">4.9</span>
                            </div>
                        </div>
                    </div>
                </div>
