      ...
      <div className="px-8 py-16 md:px-16 md:py-24 flex flex-col items-center text-center space-y-8">
        <div className="space-y-4 max-w-2xl">
          ...
          <p className="text-blue-100 text-lg md:text-xl font-medium">
            Get exclusive early access to new collections and special offers. No
            spam, just pure goodness.
          </p>
        </div>
        ...
        {message && (
          <p
            className={`font-bold transition-all ${status === 'success' ? 'text-green-300' : 'text-red-300'}`}
          >
            {message}
          </p>
        )}
