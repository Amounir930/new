...
export default function MerchantDashboard() {
    ...
    const stats = [
        { name: 'Total Revenue', value: data ? `$${data.totalRevenue.toLocaleString()}` : '$0', icon: TrendingUp, change: '+0%', color: 'text-green-600' },
        { name: 'Total Orders', value: data?.totalOrders.toString() || '0', icon: ShoppingCart, change: '+0%', color: 'text-blue-600' },
        { name: 'Products', value: data?.totalProducts.toString() || '0', icon: Package, change: '0%', color: 'text-indigo-600' },
        { name: 'Customers', value: data?.totalCustomers.toString() || '0', icon: Users, change: '+0%', color: 'text-purple-600' },
    ];
