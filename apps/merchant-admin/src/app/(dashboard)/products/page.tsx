        ...
        <div className="p-8 space-y-6">
            ...
            <div className="flex items-center gap-4">
                <div className="relative flex-1 max-w-sm">
                    ...
                    <Input placeholder="Search products..." className="pl-10 bg-muted/20 border-white/5 rounded-xl" />
                </div>
            </div>
                        ...
                        {loading ? (
                            ...
                            products.map((product) => (
                                <TableRow key={product.id} className="hover:bg-muted/20 transition-colors">
                                    ...
                                    <TableCell>
                                        <Badge variant={product.stockQuantity > 0 ? 'secondary' : 'destructive'} className="rounded-md">
                                            {product.stockQuantity} in stock
                                        </Badge>
                                    </TableCell>
                                    <TableCell>
                                        <Badge variant={product.isActive ? 'default' : 'outline'} className="rounded-md">
