...
const TAB_FIELD_MAP: Record<string, TabId> = {
  ...
  minOrderQty: 'inventory',
  lowStockThreshold: 'inventory',
  trackInventory: 'inventory',
  requiresShipping: 'inventory',
  shortDescriptionAr: 'details',
  shortDescriptionEn: 'details',
  descriptionAr: 'details',
  ...
  galleryImages: 'media',
  videoUrl: 'media',
  digitalFileUrl: 'media',
  metaTitle: 'seo',
  metaDescription: 'seo',
  keywords: 'seo',
  niche: 'advanced',
  attributes: 'advanced',
  warrantyPeriod: 'advanced',
  warrantyUnit: 'advanced',
};
...
export function ProductForm({
  ...
  const handleFormSubmit = handleSubmit(
    ...
    (fieldErrors) => {
      const firstTab = Object.keys(fieldErrors)
        .map((k) => TAB_FIELD_MAP[k])
        .find(Boolean);
      if (firstTab) setActiveTab(firstTab);
      toast.error(
        'Validation failed. Check highlighted fields for inline errors.'
      );
    }
  );
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    {...register('nameEn')}
                    className={
                      errors.nameEn ? 'border-destructive ring-destructive' : ''
                    }
                  />
                  {errors.nameEn && (
                    <p className="text-xs text-destructive">
              ...
              <div className="flex items-center justify-between rounded-lg border p-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Hides shipping fields, requires digital file URL
                  </p>
                </div>
                <Switch
                  id="isDigital"
                  checked={Boolean(isDigital)}
                  onCheckedChange={(v) => setValue('isDigital', v)}
                />
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="pricing">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Base price, discounts, cost, and tax
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1.5">
                ...
                {errors.taxPercentage && (
                  <p className="text-xs text-destructive mt-1">
                    {errors.taxPercentage.message as string}
                  </p>
                )}
              </div>
            </CardContent>
        ...
        <TabsContent value="inventory">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Stock, shipping, weight, and dimensions
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-1.5">
                  ...
                  {errors.minOrderQty && (
                    <p className="text-xs text-destructive mt-1">
                      {errors.minOrderQty.message as string}
                    </p>
                  )}
                </div>
                <div className="space-y-1.5">
              ...
              {!isDigital && (
                <>
                  <div className="flex items-center justify-between rounded-lg border p-3">
                    <div>
                      <Label htmlFor="requiresShipping" className="font-medium">
                        Requires Shipping
                      </Label>
                      <p className="text-xs text-muted-foreground">
                        Hidden for digital products
                      </p>
                    </div>
                    <Switch
                      id="requiresShipping"
                      checked={Boolean(requiresShipping)}
                      onCheckedChange={(v) => setValue('requiresShipping', v)}
                    />
                  </div>
                  <div className="space-y-1.5">
              ...
              {isDigital && (
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 text-sm text-blue-700 dark:border-blue-800 dark:bg-blue-950/20 dark:text-blue-400">
                  Weight, dimensions, and shipping fields are hidden for digital
                  products.
                </div>
              )}
            </CardContent>
        ...
        <TabsContent value="details">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Descriptions, specifications, and tags
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-1.5">
                  ...
                  {errors.shortDescriptionAr && (
                    <p className="text-xs text-destructive mt-1">
                      {errors.shortDescriptionAr.message as string}
                    </p>
                  )}
                </div>
                <div className="space-y-1.5">
                  ...
                  {errors.shortDescriptionEn && (
                    <p className="text-xs text-destructive mt-1">
                      {errors.shortDescriptionEn.message as string}
                    </p>
                  )}
                </div>
              </div>
        ...
        <TabsContent value="media">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Images, videos, and digital file links
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* Main Image */}
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <label
                    className={`flex items-center gap-2 rounded-md border border-dashed px-4 py-3 text-sm ${draftInitializing ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer hover:bg-muted/50'} ${errors.mainImage ? 'border-destructive text-destructive' : ''}`}
                  >
                    {uploadingKey === 'main' ? (
                      <Loader2 className="h-4 w-4 animate-spin" />
                    ) : (
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <label
                    className={`flex h-24 w-24 flex-col items-center justify-center gap-1 rounded-lg border border-dashed text-xs text-muted-foreground ${draftInitializing ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer hover:bg-muted/50'}`}
                  >
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const file = e.target.files?.[0];
                        if (file)
                          handleImageUpload(file, 'gallery', (url) => {
                            const current = getValues('galleryImages') ?? [];
                            setValue('galleryImages', [
                              ...current,
                              { url, order: current.length, altText: '' },
                            ]);
                          });
                      }}
                    />
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  {...register('videoUrl')}
                  className={
                    errors.videoUrl ? 'border-destructive ring-destructive' : ''
                  }
                />
                {errors.videoUrl && (
                  <p className="text-xs text-destructive mt-1">
              ...
              {isDigital && (
                <div className="space-y-1.5 rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-950/20">
                  ...
                  <Input
                    id="digitalFileUrl"
                    placeholder="https://storage.60sec.shop/..."
                  ...
                  {errors.digitalFileUrl && (
                    <p className="text-xs text-destructive mt-1">
                      {errors.digitalFileUrl.message as string}
                    </p>
                  )}
                </div>
              )}
        ...
        <TabsContent value="seo">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Search engine meta tags and publication controls
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  {...register('keywords')}
                  className={
                    errors.keywords ? 'border-destructive ring-destructive' : ''
                  }
                />
                {errors.keywords && (
                  <p className="text-xs text-destructive mt-1">
                  ...
                  [
                    {
                      ...
                      value: isActive,
                      label: 'Active',
                      desc: 'Product is live on the storefront',
                    },
                    {
                      field: 'isFeatured',
                      value: isFeatured,
                    ...
                    },
                    {
                      ...
                      value: isReturnable,
                      label: 'Returnable',
                      desc: 'Customer can request a return',
                    },
                  ] as const
                ).map(({ field, value, label, desc }) => (
                  <div
                    key={field}
        ...
        <TabsContent value="advanced">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Niche, dynamic attributes, and warranty
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
