...
const navigation = [
    ...
    { name: 'Bulk Import', href: '/dashboard/products/import', icon: UploadCloud },
            ...
            <div className="p-4 border-t border-slate-800">
                <div className="flex items-center gap-3 px-4 py-2">
                    ...
                    <div className="flex-1 overflow-hidden">
                        <p className="text-sm font-bold truncate">{session?.name || 'Merchant Store'}</p>
                        <p className="text-xs text-slate-500 truncate">{session?.email || 'admin@store.com'}</p>
                    </div>
                </div>
            </div>
        </div>
