...
export const homeTemplate: PageTemplate = {
    ...
    description: 'Modern home page with hero section, feature showcase, testimonials, and call-to-action',
    ...
    slots: [
        // Hero Section
        {
            ...
            componentName: 'Card',
            props: {
                className: 'border-0 rounded-none bg-gradient-to-br from-primary/5 to-primary/10',
            },
            children: [
                {
                    id: 'hero-content',
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            props: {
                                ...
                                children: 'Discover amazing products at unbeatable prices. Shop with confidence.',
                            },
                        },
                        {
                            id: 'hero-cta',
