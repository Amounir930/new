...
import type { PageTemplate, TemplateSlot, TemplateDataContext } from '../schema/template-schema'
 ...
 */
function resolveDataBinding(binding: string, context: TemplateDataContext): any {
 ...
 */
function evaluateCondition(condition: string, context: TemplateDataContext): boolean {
    try {
