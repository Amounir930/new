...
export const BaseBrickSchema: z.ZodObject<any> = z.object({
  ...
  props: z
    .record(z.any())
    .default({})
    .describe('Parameters passed to the component'),
  slots: z
    .record(z.array(z.lazy((): z.ZodType<any> => BaseBrickSchema)))
    .optional()
    .describe('Named slots for nested child bricks'),
  data: z
    .object({
      ...
      condition: z
        .string()
        .optional()
        .describe('Logical expression for rendering'),
    })
    .optional(),
  meta: z
    .object({
...
export const BlueprintSchema = z.object({
  ...
  root: BrickSchema.describe(
    'The root brick of the page (usually a Layout/PageContainer)'
  ),
  layout: z
    .object({
