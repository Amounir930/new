...
export declare const EnvSchema: z.ZodObject<{
    ...
    ENCRYPTION_MASTER_KEY: z.ZodEffects<z.ZodEffects<z.ZodString, string, string>, string, string>;
    JWT_EXPIRES_IN: z.ZodDefault<z.ZodString>;
    DATABASE_URL: z.ZodString;
    DB_SSL: z.ZodDefault<z.ZodEnum<["true", "false"]>>;
    ...
    GLITCHTIP_DSN: z.ZodOptional<z.ZodString>;
}, "strip", z.ZodTypeAny, {
    JWT_SECRET: string;
