...
export const PropertyEditor: React.FC = () => {
    ...
    const componentEntry = getComponentEntry(slot.componentName)
        ...
        <div className="flex flex-col h-full bg-background border-r">
            <div className="flex items-center justify-between p-4 border-b">
                <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Badge variant="outline" className="text-[10px] py-0">{slot.id}</Badge>
                    </div>
                </div>
            ...
            <div className="flex-1 overflow-auto p-4 space-y-6">
                ...
                <section className="pt-4 border-t mt-auto">
                    <Button variant="destructive" variant="outline" className="w-full gap-2 text-destructive hover:bg-destructive/10">
