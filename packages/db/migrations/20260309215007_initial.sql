...
CREATE UNIQUE INDEX "idx_pages_slug_active" ON "storefront"."pages" ("slug") WHERE (deleted_at IS NULL);
-- Add post-creation unique constraints to the "pages" table
ALTER TABLE "storefront"."pages" ADD CONSTRAINT "uq_tenant_pages_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "legal_pages" table
ALTER TABLE "storefront"."legal_pages" ADD CONSTRAINT "uq_tenant_legal_pages_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "entity_metafields" table
ALTER TABLE "storefront"."entity_metafields" ADD CONSTRAINT "uq_tenant_entity_metafields_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "loyalty_rules" table
ALTER TABLE "storefront"."loyalty_rules" ADD CONSTRAINT "uq_tenant_loyalty_rules_composite" UNIQUE ("id");
...
CREATE UNIQUE INDEX "idx_customer_email_hash" ON "storefront"."customers" ("email_hash") WHERE (deleted_at IS NULL);
-- Create index "idx_customer_phone_hash" to table: "customers"
CREATE UNIQUE INDEX "idx_customer_phone_hash" ON "storefront"."customers" ("phone_hash") WHERE (deleted_at IS NULL);
...
-- Add post-creation unique constraints to the "customers" table
ALTER TABLE "storefront"."customers" ADD CONSTRAINT "uq_tenant_customer" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "announcement_bars" table
ALTER TABLE "storefront"."announcement_bars" ADD CONSTRAINT "uq_tenant_announcement_bars_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "customer_segments" table
ALTER TABLE "storefront"."customer_segments" ADD CONSTRAINT "uq_tenant_customer_segments_composite" UNIQUE ("id");
...
CREATE UNIQUE INDEX "wallet_tx_idempotency" ON "storefront"."wallet_transactions" ("idempotency_key") WHERE (idempotency_key IS NOT NULL);
-- Add post-creation unique constraints to the "wallet_transactions" table
ALTER TABLE "storefront"."wallet_transactions" ADD CONSTRAINT "uq_tenant_wallet_transactions_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "banners" table
ALTER TABLE "storefront"."banners" ADD CONSTRAINT "uq_tenant_banners_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "smart_collections" table
ALTER TABLE "storefront"."smart_collections" ADD CONSTRAINT "uq_tenant_smart_collections_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "shipping_zones" table
ALTER TABLE "storefront"."shipping_zones" ADD CONSTRAINT "uq_tenant_shipping_zones_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "search_synonyms" table
ALTER TABLE "storefront"."search_synonyms" ADD CONSTRAINT "uq_tenant_search_synonyms_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "reviews" table
ALTER TABLE "storefront"."reviews" ADD CONSTRAINT "uq_tenant_reviews_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "product_views" table
ALTER TABLE "storefront"."product_views" ADD CONSTRAINT "uq_tenant_product_views_composite" UNIQUE ("id");
-- Create "popups" table
...
-- Add post-creation unique constraints to the "popups" table
ALTER TABLE "storefront"."popups" ADD CONSTRAINT "uq_tenant_popups_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "currency_rates" table
ALTER TABLE "storefront"."currency_rates" ADD CONSTRAINT "uq_tenant_currency_rates_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "outbox_events" table
ALTER TABLE "storefront"."outbox_events" ADD CONSTRAINT "uq_tenant_outbox_events_composite" UNIQUE ("id", "created_at");
...
CREATE TABLE "storefront"."abandoned_checkouts" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_ac_customer" FOREIGN KEY ("customer_id") REFERENCES "storefront"."customers" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT
);
...
-- Add post-creation unique constraints to the "abandoned_checkouts" table
ALTER TABLE "storefront"."abandoned_checkouts" ADD CONSTRAINT "uq_tenant_abandoned_checkouts_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "affiliate_partners" table
ALTER TABLE "storefront"."affiliate_partners" ADD CONSTRAINT "uq_tenant_affiliate" UNIQUE ("id");
...
CREATE TABLE "storefront"."affiliate_transactions" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_afftx_partner" FOREIGN KEY ("partner_id") REFERENCES "storefront"."affiliate_partners" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "affiliate_transactions" table
ALTER TABLE "storefront"."affiliate_transactions" ADD CONSTRAINT "uq_tenant_affiliate_transactions_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."b2b_companies" (
  ...
  CONSTRAINT "chk_credit_utilization" CHECK (credit_used <= credit_limit),
  CONSTRAINT "chk_tax_id_len" CHECK ((tax_id IS NULL) OR (length((tax_id)::text) >= 5))
);
-- Add post-creation unique constraints to the "b2b_companies" table
ALTER TABLE "storefront"."b2b_companies" ADD CONSTRAINT "uq_tenant_b2b_companies_composite" UNIQUE ("id");
-- Create "brands" table
...
CREATE UNIQUE INDEX "idx_brands_slug_active" ON "storefront"."brands" ("slug") WHERE (deleted_at IS NULL);
-- Add post-creation unique constraints to the "brands" table
ALTER TABLE "storefront"."brands" ADD CONSTRAINT "uq_tenant_brands_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."categories" (
  ...
  "path" text NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_cat_parent" FOREIGN KEY ("parent_id") REFERENCES "storefront"."categories" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
CREATE UNIQUE INDEX "idx_categories_slug_active" ON "storefront"."categories" ("slug") WHERE (deleted_at IS NULL);
-- Add post-creation unique constraints to the "categories" table
ALTER TABLE "storefront"."categories" ADD CONSTRAINT "uq_tenant_cat" UNIQUE ("id");
...
CREATE UNIQUE INDEX "idx_products_sku_active" ON "storefront"."products" ("sku") WHERE (deleted_at IS NULL);
-- Create index "idx_products_slug_active" to table: "products"
CREATE UNIQUE INDEX "idx_products_slug_active" ON "storefront"."products" ("slug") WHERE (deleted_at IS NULL);
-- Create index "idx_products_tags" to table: "products"
CREATE INDEX "idx_products_tags" ON "storefront"."products" USING GIN ("tags");
-- Add post-creation unique constraints to the "products" table
ALTER TABLE "storefront"."products" ADD CONSTRAINT "uq_tenant_product" UNIQUE ("id");
...
CREATE TABLE "storefront"."b2b_pricing_tiers" (
  ...
  CONSTRAINT "fk_b2bpt_product" FOREIGN KEY ("product_id") REFERENCES "storefront"."products" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "b2b_pricing_tiers" table
ALTER TABLE "storefront"."b2b_pricing_tiers" ADD CONSTRAINT "uq_tenant_b2b_pricing_tiers_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "b2b_users" table
ALTER TABLE "storefront"."b2b_users" ADD CONSTRAINT "uq_tenant_b2b_users_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "blog_categories" table
ALTER TABLE "storefront"."blog_categories" ADD CONSTRAINT "uq_tenant_blog_categories_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."blog_posts" (
  ...
  "content" jsonb NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_bp_category" FOREIGN KEY ("category_id") REFERENCES "storefront"."blog_categories" ("id") ON UPDATE NO ACTION ON DELETE SET NULL
);
...
CREATE UNIQUE INDEX "idx_blog_slug_active" ON "storefront"."blog_posts" ("slug") WHERE (deleted_at IS NULL);
-- Create index "idx_blog_tags" to table: "blog_posts"
CREATE INDEX "idx_blog_tags" ON "storefront"."blog_posts" USING GIN ("tags");
-- Add post-creation unique constraints to the "blog_posts" table
ALTER TABLE "storefront"."blog_posts" ADD CONSTRAINT "uq_tenant_blog_posts_composite" UNIQUE ("id");
-- Create "carts" table
CREATE TABLE "storefront"."carts" (
  ...
  "lock_version" integer NOT NULL DEFAULT 1,
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_cart_customer" FOREIGN KEY ("customer_id") REFERENCES "storefront"."customers" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "carts" table
ALTER TABLE "storefront"."carts" ADD CONSTRAINT "uq_tenant_cart" UNIQUE ("id");
...
CREATE TABLE "storefront"."cart_items" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_ci_cart" FOREIGN KEY ("cart_id") REFERENCES "storefront"."carts" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
...
-- Add post-creation unique constraints to the "cart_items" table
ALTER TABLE "storefront"."cart_items" ADD CONSTRAINT "uq_tenant_cart_items_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "coupons" table
ALTER TABLE "storefront"."coupons" ADD CONSTRAINT "uq_tenant_coupon_id" UNIQUE ("id");
...
CREATE TABLE "storefront"."coupon_usages" (
  ...
  CONSTRAINT "fk_cu_coupon" FOREIGN KEY ("coupon_id") REFERENCES "storefront"."coupons" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT
);
...
-- Add post-creation unique constraints to the "coupon_usages" table
ALTER TABLE "storefront"."coupon_usages" ADD CONSTRAINT "uq_tenant_coupon_usages_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."customer_addresses" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_addr_cust" FOREIGN KEY ("customer_id") REFERENCES "storefront"."customers" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
CREATE UNIQUE INDEX "uq_cust_default_addr" ON "storefront"."customer_addresses" ("customer_id") WHERE (is_default = true);
-- Add post-creation unique constraints to the "customer_addresses" table
ALTER TABLE "storefront"."customer_addresses" ADD CONSTRAINT "uq_tenant_customer_addresses_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."customer_consents" (
  ...
  "user_agent" text NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_consent_cust" FOREIGN KEY ("customer_id") REFERENCES "storefront"."customers" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT
);
...
-- Add post-creation unique constraints to the "customer_consents" table
ALTER TABLE "storefront"."customer_consents" ADD CONSTRAINT "uq_tenant_customer_consents_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "price_rules" table
ALTER TABLE "storefront"."price_rules" ADD CONSTRAINT "uq_tenant_price_rule" UNIQUE ("id");
...
CREATE TABLE "storefront"."discount_codes" (
  ...
  CONSTRAINT "fk_dc_price_rule" FOREIGN KEY ("price_rule_id") REFERENCES "storefront"."price_rules" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "discount_codes" table
ALTER TABLE "storefront"."discount_codes" ADD CONSTRAINT "uq_tenant_discount_codes_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "faq_categories" table
ALTER TABLE "storefront"."faq_categories" ADD CONSTRAINT "uq_tenant_faq_categories_composite" UNIQUE ("id");
-- Create "faqs" table
...
-- Add post-creation unique constraints to the "faqs" table
ALTER TABLE "storefront"."faqs" ADD CONSTRAINT "uq_tenant_faqs_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "flash_sales" table
ALTER TABLE "storefront"."flash_sales" ADD CONSTRAINT "uq_tenant_flash_sale" UNIQUE ("id");
...
CREATE TABLE "storefront"."flash_sale_products" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_fsp_flash_sale" FOREIGN KEY ("flash_sale_id") REFERENCES "storefront"."flash_sales" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "flash_sale_products" table
ALTER TABLE "storefront"."flash_sale_products" ADD CONSTRAINT "uq_tenant_flash_sale_products_composite" UNIQUE ("id");
-- Create "orders" table
CREATE TABLE "storefront"."orders" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_ord_customer" FOREIGN KEY ("customer_id") REFERENCES "storefront"."customers" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
CREATE UNIQUE INDEX "idx_orders_idempotency" ON "storefront"."orders" ("idempotency_key") WHERE (idempotency_key IS NOT NULL);
-- Create index "idx_orders_number_active" to table: "orders"
CREATE UNIQUE INDEX "idx_orders_number_active" ON "storefront"."orders" ("order_number") WHERE (deleted_at IS NULL);
-- Create index "idx_orders_payment_ref" to table: "orders"
CREATE INDEX "idx_orders_payment_ref" ON "storefront"."orders" ("payment_gateway_reference") WHERE (payment_gateway_reference IS NOT NULL);
-- Add post-creation unique constraints to the "orders" table
ALTER TABLE "storefront"."orders" ADD CONSTRAINT "uq_tenant_order" UNIQUE ("id");
...
CREATE TABLE "storefront"."fulfillments" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_ful_order" FOREIGN KEY ("order_id") REFERENCES "storefront"."orders" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT
);
...
-- Add post-creation unique constraints to the "fulfillments" table
ALTER TABLE "storefront"."fulfillments" ADD CONSTRAINT "uq_tenant_fulfillments_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."product_variants" (
  ...
  "embedding" text NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_var_prod" FOREIGN KEY ("product_id") REFERENCES "storefront"."products" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
CREATE UNIQUE INDEX "idx_variant_sku_active" ON "storefront"."product_variants" ("sku") WHERE (deleted_at IS NULL);
...
-- Add post-creation unique constraints to the "product_variants" table
ALTER TABLE "storefront"."product_variants" ADD CONSTRAINT "uq_tenant_variant" UNIQUE ("id");
...
CREATE TABLE "storefront"."order_items" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_oi_order" FOREIGN KEY ("order_id") REFERENCES "storefront"."orders" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
  CONSTRAINT "fk_oi_variant" FOREIGN KEY ("variant_id") REFERENCES "storefront"."product_variants" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
CREATE INDEX "idx_oi_product" ON "storefront"."order_items" ("product_id");
...
-- Add post-creation unique constraints to the "order_items" table
ALTER TABLE "storefront"."order_items" ADD CONSTRAINT "uq_tenant_order_items_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "fulfillment_items" table
ALTER TABLE "storefront"."fulfillment_items" ADD CONSTRAINT "uq_tenant_fulfillment_items_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "locations" table
ALTER TABLE "storefront"."locations" ADD CONSTRAINT "uq_tenant_loc" UNIQUE ("id");
...
CREATE TABLE "storefront"."inventory_levels" (
  ...
  CONSTRAINT "fk_inv_loc" FOREIGN KEY ("location_id") REFERENCES "storefront"."locations" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
  CONSTRAINT "fk_inv_variant" FOREIGN KEY ("variant_id") REFERENCES "storefront"."product_variants" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "inventory_levels" table
ALTER TABLE "storefront"."inventory_levels" ADD CONSTRAINT "uq_tenant_inventory_levels_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."inventory_movements" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_im_loc" FOREIGN KEY ("location_id") REFERENCES "storefront"."locations" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
  CONSTRAINT "fk_im_variant" FOREIGN KEY ("variant_id") REFERENCES "storefront"."product_variants" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "inventory_movements" table
ALTER TABLE "storefront"."inventory_movements" ADD CONSTRAINT "uq_tenant_inventory_movements_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."inventory_reservations" (
  ...
  "quantity" integer NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_ir_loc" FOREIGN KEY ("location_id") REFERENCES "storefront"."locations" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
  CONSTRAINT "fk_ir_variant" FOREIGN KEY ("variant_id") REFERENCES "storefront"."product_variants" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "inventory_reservations" table
ALTER TABLE "storefront"."inventory_reservations" ADD CONSTRAINT "uq_tenant_inventory_reservations_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."inventory_transfers" (
  ...
  "version" integer NOT NULL DEFAULT 1,
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_it_from_loc" FOREIGN KEY ("from_location_id") REFERENCES "storefront"."locations" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
  CONSTRAINT "fk_it_to_loc" FOREIGN KEY ("to_location_id") REFERENCES "storefront"."locations" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "inventory_transfers" table
ALTER TABLE "storefront"."inventory_transfers" ADD CONSTRAINT "uq_tenant_inventory_transfers_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."inventory_transfer_items" (
  ...
  CONSTRAINT "fk_iti_variant" FOREIGN KEY ("variant_id") REFERENCES "storefront"."product_variants" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT
);
...
-- Add post-creation unique constraints to the "inventory_transfer_items" table
ALTER TABLE "storefront"."inventory_transfer_items" ADD CONSTRAINT "uq_tenant_inventory_transfer_items_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "kb_categories" table
ALTER TABLE "storefront"."kb_categories" ADD CONSTRAINT "uq_tenant_kb_categories_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "kb_articles" table
ALTER TABLE "storefront"."kb_articles" ADD CONSTRAINT "uq_tenant_kb_articles_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."order_edits" (
  ...
  CONSTRAINT "fk_oe_order" FOREIGN KEY ("order_id") REFERENCES "storefront"."orders" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT
);
-- Create index "idx_order_edits" to table: "order_edits"
CREATE INDEX "idx_order_edits" ON "storefront"."order_edits" ("order_id");
-- Add post-creation unique constraints to the "order_edits" table
ALTER TABLE "storefront"."order_edits" ADD CONSTRAINT "uq_tenant_order_edits_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."order_timeline" (
  ...
  "user_agent" text NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_ot_order" FOREIGN KEY ("order_id") REFERENCES "storefront"."orders" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT
);
...
-- Add post-creation unique constraints to the "order_timeline" table
ALTER TABLE "storefront"."order_timeline" ADD CONSTRAINT "uq_tenant_order_timeline_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."payment_logs" (
  ...
  "ip_address" inet NULL,
  PRIMARY KEY ("id", "created_at"),
  CONSTRAINT "fk_pl_order" FOREIGN KEY ("order_id") REFERENCES "storefront"."orders" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
  CONSTRAINT "chk_payment_pci_scrub" CHECK ((raw_response IS NULL) OR (NOT (raw_response ?| ARRAY['cvv'::text, 'card_number'::text, 'pan'::text])))
) PARTITION BY RANGE ("created_at");
...
-- Add post-creation unique constraints to the "payment_logs" table
ALTER TABLE "storefront"."payment_logs" ADD CONSTRAINT "uq_tenant_payment_logs_composite" UNIQUE ("id", "created_at");
...
CREATE UNIQUE INDEX "uq_tenant_primary_market" ON "storefront"."markets" ("id") WHERE (is_primary = true);
-- Add post-creation unique constraints to the "markets" table
ALTER TABLE "storefront"."markets" ADD CONSTRAINT "uq_tenant_markets_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."price_lists" (
  ...
  "compare_at_price" numeric(12,4) NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_pl_market" FOREIGN KEY ("market_id") REFERENCES "storefront"."markets" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "price_lists" table
ALTER TABLE "storefront"."price_lists" ADD CONSTRAINT "uq_tenant_price_lists_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."product_attributes" (
  ...
  CONSTRAINT "fk_attr_prod" FOREIGN KEY ("product_id") REFERENCES "storefront"."products" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
...
-- Add post-creation unique constraints to the "product_attributes" table
ALTER TABLE "storefront"."product_attributes" ADD CONSTRAINT "uq_tenant_product_attributes_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "product_bundles" table
ALTER TABLE "storefront"."product_bundles" ADD CONSTRAINT "uq_tenant_bundle" UNIQUE ("id");
...
CREATE TABLE "storefront"."product_bundle_items" (
  ...
  "quantity" integer NOT NULL DEFAULT 1,
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_pbi_bundle" FOREIGN KEY ("bundle_id") REFERENCES "storefront"."product_bundles" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT
);
...
-- Add post-creation unique constraints to the "product_bundle_items" table
ALTER TABLE "storefront"."product_bundle_items" ADD CONSTRAINT "uq_tenant_product_bundle_items_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."product_images" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_img_prod" FOREIGN KEY ("product_id") REFERENCES "storefront"."products" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE UNIQUE INDEX "uq_primary_image" ON "storefront"."product_images" ("product_id") WHERE (is_primary = true);
-- Add post-creation unique constraints to the "product_images" table
ALTER TABLE "storefront"."product_images" ADD CONSTRAINT "uq_tenant_product_images_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "suppliers" table
ALTER TABLE "storefront"."suppliers" ADD CONSTRAINT "uq_tenant_suppliers_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."purchase_orders" (
  ...
  CONSTRAINT "fk_po_location" FOREIGN KEY ("location_id") REFERENCES "storefront"."locations" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "purchase_orders" table
ALTER TABLE "storefront"."purchase_orders" ADD CONSTRAINT "uq_tenant_purchase_orders_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."purchase_order_items" (
  ...
  CONSTRAINT "fk_poi_variant" FOREIGN KEY ("variant_id") REFERENCES "storefront"."product_variants" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "purchase_order_items" table
ALTER TABLE "storefront"."purchase_order_items" ADD CONSTRAINT "uq_tenant_purchase_order_items_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."refunds" (
  ...
  "reason" text NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_ref_order" FOREIGN KEY ("order_id") REFERENCES "storefront"."orders" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "refunds" table
ALTER TABLE "storefront"."refunds" ADD CONSTRAINT "uq_tenant_refund" UNIQUE ("id");
...
CREATE TABLE "storefront"."refund_items" (
  ...
  CONSTRAINT "fk_ri_refund" FOREIGN KEY ("refund_id") REFERENCES "storefront"."refunds" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "refund_items" table
ALTER TABLE "storefront"."refund_items" ADD CONSTRAINT "uq_tenant_refund_items_composite" UNIQUE ("id");
...
CREATE TABLE "storefront"."rma_requests" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_rma_order" FOREIGN KEY ("order_id") REFERENCES "storefront"."orders" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "rma_requests" table
ALTER TABLE "storefront"."rma_requests" ADD CONSTRAINT "uq_tenant_rma" UNIQUE ("id");
...
CREATE TABLE "storefront"."rma_items" (
  ...
  CONSTRAINT "fk_rmai_rma" FOREIGN KEY ("rma_id") REFERENCES "storefront"."rma_requests" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
  CONSTRAINT "qty_positive" CHECK (quantity > 0)
);
-- Create index "idx_rma_items_rma" to table: "rma_items"
CREATE INDEX "idx_rma_items_rma" ON "storefront"."rma_items" ("rma_id");
-- Add post-creation unique constraints to the "rma_items" table
ALTER TABLE "storefront"."rma_items" ADD CONSTRAINT "uq_tenant_rma_items_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "staff_roles" table
ALTER TABLE "storefront"."staff_roles" ADD CONSTRAINT "uq_tenant_staff_roles_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "staff_members" table
ALTER TABLE "storefront"."staff_members" ADD CONSTRAINT "uq_tenant_staff" UNIQUE ("id");
...
CREATE TABLE "storefront"."staff_sessions" (
  ...
  CONSTRAINT "fk_ss_staff" FOREIGN KEY ("staff_id") REFERENCES "storefront"."staff_members" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
-- Add post-creation unique constraints to the "staff_sessions" table
ALTER TABLE "storefront"."staff_sessions" ADD CONSTRAINT "uq_tenant_staff_sessions_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "tax_categories" table
ALTER TABLE "storefront"."tax_categories" ADD CONSTRAINT "uq_tenant_tax_category" UNIQUE ("id");
...
CREATE TABLE "storefront"."tax_rules" (
  ...
  CONSTRAINT "fk_tr_tax_category" FOREIGN KEY ("tax_category_id") REFERENCES "storefront"."tax_categories" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "tax_rules" table
ALTER TABLE "storefront"."tax_rules" ADD CONSTRAINT "uq_tenant_tax_rules_composite" UNIQUE ("id");
...
-- Add post-creation unique constraints to the "app_installations" table
ALTER TABLE "storefront"."app_installations" ADD CONSTRAINT "uq_tenant_app" UNIQUE ("id");
...
CREATE TABLE "storefront"."webhook_subscriptions" (
  ...
  "suspended_at" timestamptz NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "fk_ws_app" FOREIGN KEY ("app_id") REFERENCES "storefront"."app_installations" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
...
-- Add post-creation unique constraints to the "webhook_subscriptions" table
ALTER TABLE "storefront"."webhook_subscriptions" ADD CONSTRAINT "uq_tenant_webhook_subscriptions_composite" UNIQUE ("id");
