...
import { abandonedCheckoutsInStorefront, affiliatePartnersInStorefront, affiliateTransactionsInStorefront, appInstallationsInStorefront, b2BCompaniesInStorefront, b2BPricingTiersInStorefront, b2BUsersInStorefront, blogCategoriesInStorefront, blogPostsInStorefront, brandsInStorefront, cartItemsInStorefront, cartsInStorefront, categoriesInStorefront, couponsInStorefront, couponUsagesInStorefront, customerAddressesInStorefront, customerConsentsInStorefront, customersInStorefront, discountCodesInStorefront, faqCategoriesInStorefront, faqsInStorefront, flashSaleProductsInStorefront, flashSalesInStorefront, fulfillmentItemsInStorefront, fulfillmentsInStorefront, inventoryLevelsInStorefront, inventoryMovementsInStorefront, inventoryReservationsInStorefront, inventoryTransferItemsInStorefront, inventoryTransfersInStorefront, kbArticlesInStorefront, kbCategoriesInStorefront, locationsInStorefront, marketsInStorefront, orderEditsInStorefront, orderItemsInStorefront, ordersInStorefront, orderTimelineInStorefront, priceListsInStorefront, priceRulesInStorefront, productAttributesInStorefront, productBundleItemsInStorefront, productBundlesInStorefront, productImagesInStorefront, productsInStorefront, productVariantsInStorefront, purchaseOrderItemsInStorefront, purchaseOrdersInStorefront, refundItemsInStorefront, refundsInStorefront, rmaItemsInStorefront, rmaRequestsInStorefront, staffMembersInStorefront, staffRolesInStorefront, staffSessionsInStorefront, suppliersInStorefront, taxCategoriesInStorefront, taxRulesInStorefront, webhookSubscriptionsInStorefront, } from './schema';
export const abandonedCheckoutsInStorefrontRelations = relations(abandonedCheckoutsInStorefront, ({ one }) => ({
...
export const customersInStorefrontRelations = relations(customersInStorefront, ({ many }) => ({
...
export const affiliateTransactionsInStorefrontRelations = relations(affiliateTransactionsInStorefront, ({ one }) => ({
...
export const affiliatePartnersInStorefrontRelations = relations(affiliatePartnersInStorefront, ({ many }) => ({
    affiliateTransactionsInStorefronts: many(affiliateTransactionsInStorefront),
}));
export const categoriesInStorefrontRelations = relations(categoriesInStorefront, ({ one, many }) => ({
...
export const productsInStorefrontRelations = relations(productsInStorefront, ({ one, many }) => ({
...
export const brandsInStorefrontRelations = relations(brandsInStorefront, ({ many }) => ({
    productsInStorefronts: many(productsInStorefront),
}));
export const b2BPricingTiersInStorefrontRelations = relations(b2BPricingTiersInStorefront, ({ one }) => ({
...
export const b2BCompaniesInStorefrontRelations = relations(b2BCompaniesInStorefront, ({ many }) => ({
    b2BPricingTiersInStorefronts: many(b2BPricingTiersInStorefront),
    b2BUsersInStorefronts: many(b2BUsersInStorefront),
}));
export const b2BUsersInStorefrontRelations = relations(b2BUsersInStorefront, ({ one }) => ({
    b2BCompaniesInStorefront: one(b2BCompaniesInStorefront, {
        fields: [b2BUsersInStorefront.companyId],
        references: [b2BCompaniesInStorefront.id],
    }),
}));
export const blogPostsInStorefrontRelations = relations(blogPostsInStorefront, ({ one }) => ({
...
export const blogCategoriesInStorefrontRelations = relations(blogCategoriesInStorefront, ({ many }) => ({
    blogPostsInStorefronts: many(blogPostsInStorefront),
}));
export const cartsInStorefrontRelations = relations(cartsInStorefront, ({ one, many }) => ({
    customersInStorefront: one(customersInStorefront, {
...
export const cartItemsInStorefrontRelations = relations(cartItemsInStorefront, ({ one }) => ({
    cartsInStorefront: one(cartsInStorefront, {
        fields: [cartItemsInStorefront.cartId],
        references: [cartsInStorefront.id],
    }),
}));
export const couponUsagesInStorefrontRelations = relations(couponUsagesInStorefront, ({ one }) => ({
    couponsInStorefront: one(couponsInStorefront, {
        fields: [couponUsagesInStorefront.couponId],
        references: [couponsInStorefront.id],
    }),
}));
export const couponsInStorefrontRelations = relations(couponsInStorefront, ({ many }) => ({
    couponUsagesInStorefronts: many(couponUsagesInStorefront),
}));
export const customerAddressesInStorefrontRelations = relations(customerAddressesInStorefront, ({ one }) => ({
    customersInStorefront: one(customersInStorefront, {
        fields: [customerAddressesInStorefront.customerId],
        references: [customersInStorefront.id],
    }),
}));
export const customerConsentsInStorefrontRelations = relations(customerConsentsInStorefront, ({ one }) => ({
    customersInStorefront: one(customersInStorefront, {
        fields: [customerConsentsInStorefront.customerId],
        references: [customersInStorefront.id],
    }),
}));
export const discountCodesInStorefrontRelations = relations(discountCodesInStorefront, ({ one }) => ({
...
export const priceRulesInStorefrontRelations = relations(priceRulesInStorefront, ({ many }) => ({
    discountCodesInStorefronts: many(discountCodesInStorefront),
}));
export const faqsInStorefrontRelations = relations(faqsInStorefront, ({ one }) => ({
...
export const faqCategoriesInStorefrontRelations = relations(faqCategoriesInStorefront, ({ many }) => ({
    faqsInStorefronts: many(faqsInStorefront),
}));
export const flashSaleProductsInStorefrontRelations = relations(flashSaleProductsInStorefront, ({ one }) => ({
...
export const flashSalesInStorefrontRelations = relations(flashSalesInStorefront, ({ many }) => ({
    flashSaleProductsInStorefronts: many(flashSaleProductsInStorefront),
}));
export const ordersInStorefrontRelations = relations(ordersInStorefront, ({ one, many }) => ({
    customersInStorefront: one(customersInStorefront, {
...
export const fulfillmentsInStorefrontRelations = relations(fulfillmentsInStorefront, ({ one, many }) => ({
...
export const productVariantsInStorefrontRelations = relations(productVariantsInStorefront, ({ one, many }) => ({
    productsInStorefront: one(productsInStorefront, {
    ...
    inventoryTransferItemsInStorefronts: many(inventoryTransferItemsInStorefront),
    purchaseOrderItemsInStorefronts: many(purchaseOrderItemsInStorefront),
}));
export const orderItemsInStorefrontRelations = relations(orderItemsInStorefront, ({ one, many }) => ({
    ordersInStorefront: one(ordersInStorefront, {
...
export const fulfillmentItemsInStorefrontRelations = relations(fulfillmentItemsInStorefront, ({ one }) => ({
...
export const inventoryLevelsInStorefrontRelations = relations(inventoryLevelsInStorefront, ({ one }) => ({
...
export const locationsInStorefrontRelations = relations(locationsInStorefront, ({ many }) => ({
    inventoryLevelsInStorefronts: many(inventoryLevelsInStorefront),
    inventoryMovementsInStorefronts: many(inventoryMovementsInStorefront),
    inventoryReservationsInStorefronts: many(inventoryReservationsInStorefront),
    inventoryTransfersInStorefronts_fromLocationId: many(inventoryTransfersInStorefront, {
        relationName: 'inventoryTransfersInStorefront_fromLocationId_locationsInStorefront_id',
    }),
    inventoryTransfersInStorefronts_toLocationId: many(inventoryTransfersInStorefront, {
        relationName: 'inventoryTransfersInStorefront_toLocationId_locationsInStorefront_id',
    }),
    purchaseOrdersInStorefronts: many(purchaseOrdersInStorefront),
}));
export const inventoryMovementsInStorefrontRelations = relations(inventoryMovementsInStorefront, ({ one }) => ({
    locationsInStorefront: one(locationsInStorefront, {
...
export const inventoryReservationsInStorefrontRelations = relations(inventoryReservationsInStorefront, ({ one }) => ({
    locationsInStorefront: one(locationsInStorefront, {
...
export const inventoryTransfersInStorefrontRelations = relations(inventoryTransfersInStorefront, ({ one, many }) => ({
...
export const inventoryTransferItemsInStorefrontRelations = relations(inventoryTransferItemsInStorefront, ({ one }) => ({
...
export const orderEditsInStorefrontRelations = relations(orderEditsInStorefront, ({ one }) => ({
    orderItemsInStorefront: one(orderItemsInStorefront, {
...
export const kbArticlesInStorefrontRelations = relations(kbArticlesInStorefront, ({ one }) => ({
...
export const kbCategoriesInStorefrontRelations = relations(kbCategoriesInStorefront, ({ many }) => ({
    kbArticlesInStorefronts: many(kbArticlesInStorefront),
}));
export const orderTimelineInStorefrontRelations = relations(orderTimelineInStorefront, ({ one }) => ({
    ordersInStorefront: one(ordersInStorefront, {
        fields: [orderTimelineInStorefront.orderId],
        references: [ordersInStorefront.id],
    }),
}));
export const productBundleItemsInStorefrontRelations = relations(productBundleItemsInStorefront, ({ one }) => ({
...
export const productBundlesInStorefrontRelations = relations(productBundlesInStorefront, ({ many }) => ({
    productBundleItemsInStorefronts: many(productBundleItemsInStorefront),
}));
export const priceListsInStorefrontRelations = relations(priceListsInStorefront, ({ one }) => ({
    marketsInStorefront: one(marketsInStorefront, {
        fields: [priceListsInStorefront.marketId],
        references: [marketsInStorefront.id],
    }),
}));
export const marketsInStorefrontRelations = relations(marketsInStorefront, ({ many }) => ({
    priceListsInStorefronts: many(priceListsInStorefront),
}));
export const productAttributesInStorefrontRelations = relations(productAttributesInStorefront, ({ one }) => ({
    productsInStorefront: one(productsInStorefront, {
        fields: [productAttributesInStorefront.productId],
        references: [productsInStorefront.id],
    }),
}));
export const productImagesInStorefrontRelations = relations(productImagesInStorefront, ({ one }) => ({
    productsInStorefront: one(productsInStorefront, {
        fields: [productImagesInStorefront.productId],
        references: [productsInStorefront.id],
    }),
}));
export const purchaseOrdersInStorefrontRelations = relations(purchaseOrdersInStorefront, ({ one, many }) => ({
    locationsInStorefront: one(locationsInStorefront, {
...
export const suppliersInStorefrontRelations = relations(suppliersInStorefront, ({ many }) => ({
    purchaseOrdersInStorefronts: many(purchaseOrdersInStorefront),
}));
export const purchaseOrderItemsInStorefrontRelations = relations(purchaseOrderItemsInStorefront, ({ one }) => ({
...
export const rmaItemsInStorefrontRelations = relations(rmaItemsInStorefront, ({ one }) => ({
    orderItemsInStorefront: one(orderItemsInStorefront, {
...
export const rmaRequestsInStorefrontRelations = relations(rmaRequestsInStorefront, ({ one, many }) => ({
    rmaItemsInStorefronts: many(rmaItemsInStorefront),
    ordersInStorefront: one(ordersInStorefront, {
...
export const refundsInStorefrontRelations = relations(refundsInStorefront, ({ one, many }) => ({
    ordersInStorefront: one(ordersInStorefront, {
...
export const refundItemsInStorefrontRelations = relations(refundItemsInStorefront, ({ one }) => ({
    orderItemsInStorefront: one(orderItemsInStorefront, {
...
export const staffMembersInStorefrontRelations = relations(staffMembersInStorefront, ({ one, many }) => ({
...
export const staffRolesInStorefrontRelations = relations(staffRolesInStorefront, ({ many }) => ({
    staffMembersInStorefronts: many(staffMembersInStorefront),
}));
export const staffSessionsInStorefrontRelations = relations(staffSessionsInStorefront, ({ one }) => ({
...
export const taxRulesInStorefrontRelations = relations(taxRulesInStorefront, ({ one }) => ({
...
export const taxCategoriesInStorefrontRelations = relations(taxCategoriesInStorefront, ({ many }) => ({
    taxRulesInStorefronts: many(taxRulesInStorefront),
}));
export const webhookSubscriptionsInStorefrontRelations = relations(webhookSubscriptionsInStorefront, ({ one }) => ({
...
export const appInstallationsInStorefrontRelations = relations(appInstallationsInStorefront, ({ many }) => ({
