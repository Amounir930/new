...
ALTER TABLE "governance"."plan_change_history" 
    ALTER COLUMN "from_plan" TYPE "public"."tenant_plan" USING "from_plan"::"public"."tenant_plan",
    ALTER COLUMN "to_plan" TYPE "public"."tenant_plan" USING "to_plan"::"public"."tenant_plan";
...
ALTER TABLE "governance"."audit_logs" 
    ADD COLUMN IF NOT EXISTS "actor_type" "public"."actor_type" DEFAULT 'tenant_admin' NOT NULL;
...
ALTER TABLE "storefront"."currency_rates" 
...
ALTER TABLE "storefront"."product_images" ADD CONSTRAINT "product_images_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "storefront"."products"("id") ON DELETE CASCADE;
...
ALTER TABLE "storefront"."product_attributes" ADD CONSTRAINT "product_attributes_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "storefront"."products"("id") ON DELETE CASCADE;
...
ALTER TABLE "storefront"."related_products" ADD CONSTRAINT "related_products_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "storefront"."products"("id") ON DELETE CASCADE;
ALTER TABLE "storefront"."related_products" ADD CONSTRAINT "related_products_related_product_id_products_id_fk" FOREIGN KEY ("related_product_id") REFERENCES "storefront"."products"("id") ON DELETE CASCADE;
...
ALTER TABLE "storefront"."product_category_mapping" ADD CONSTRAINT "product_category_mapping_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "storefront"."products"("id") ON DELETE CASCADE;
ALTER TABLE "storefront"."product_category_mapping" ADD CONSTRAINT "product_category_mapping_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "storefront"."categories"("id") ON DELETE CASCADE;
...
ALTER TABLE storefront.outbox_events SET (
    autovacuum_vacuum_scale_factor = 0.01,
    autovacuum_analyze_scale_factor = 0.005,
    autovacuum_vacuum_cost_limit = 1000
);

ALTER TABLE storefront.inventory_levels SET (
    autovacuum_vacuum_scale_factor = 0.01,
    autovacuum_analyze_scale_factor = 0.005
);

ALTER TABLE storefront.carts SET (
