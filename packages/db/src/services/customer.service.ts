...
import { type Customer, type NewCustomer, customers } from '../schema/storefront/customers.js';
...
export class CustomerService {
     ...
     */
    async create(data: Omit<NewCustomer, 'id' | 'emailHash' | 'phoneHash' | 'createdAt' | 'lastLoginAt' | 'isVerified' | 'loyaltyPoints' | 'walletBalance'>): Promise<Customer> {
