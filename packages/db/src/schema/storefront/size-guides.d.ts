 ...
 * Size Guides Table
 */
export declare const sizeGuides: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "size_guides";
    schema: undefined;
    columns: {
        ...
        tableData: import("drizzle-orm/pg-core").PgColumn<{
            name: "table_data";
            tableName: "size_guides";
            dataType: "json";
            columnType: "PgJsonb";
...
//# sourceMappingURL=size-guides.d.ts.map