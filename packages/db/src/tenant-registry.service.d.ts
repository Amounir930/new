...
export declare class TenantRegistryService {
     ...
     */
    getByIdentifier(identifier: string): Promise<Tenant | null>;
    /**
     ...
     */
    updateStatus(tenantId: string, status: 'active' | 'suspended' | 'pending'): Promise<void>;
    /**
     * Update tenant subscription plan
     */
    updatePlan(tenantId: string, plan: 'free' | 'basic' | 'pro' | 'enterprise'): Promise<void>;
}
