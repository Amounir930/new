...
// Import the TS version which uses simpler encryption (no scrypt)
...
describe('Encryption.js Utility Functions', () => {
    ...
    describe('decrypt (JS)', () => {
        ...
        it('should throw S7 Violation for malformed data - missing encrypted', () => {
            ...
            expect(() => jsDecrypt(malformed, testMasterKey, undefined))
                .toThrow('S7 Violation: Malformed encrypted data structure');
        });
        ...
        it('should throw for tampered ciphertext', () => {
            ...
            expect(() => jsDecrypt(encrypted, testMasterKey, undefined))
        ...
        it('should throw for wrong key', () => {
            ...
            expect(() => jsDecrypt(encrypted, wrongKey, undefined))
                .toThrow('S7 Violation');
        });
        ...
        describe('fallback key support', () => {
            ...
            it('should throw when both keys fail', () => {
                ...
                expect(() => jsDecrypt(malformed, 'key2', 'key1'))
                    .toThrow('Decryption failed with both primary and fallback keys');
            });
        });
    });
...
describe('EncryptionService Class', () => {
    ...
    describe('constructor validation', () => {
        ...
        it('should throw in production if ENCRYPTION_MASTER_KEY is missing', () => {
            ...
            expect(() => new JSEncryptionService(config))
                .toThrow('S1 Violation: ENCRYPTION_MASTER_KEY is required');
        });
        ...
        it('should throw if key is too short', () => {
            ...
            expect(() => new JSEncryptionService(config))
                .toThrow('S1 Violation: ENCRYPTION_MASTER_KEY must be at least 32 characters');
        });
        ...
        it('should throw in production if key contains forbidden pattern "default"', () => {
            const config = createMockConfig({
                NODE_ENV: 'production',
                ENCRYPTION_MASTER_KEY: 'default-encryption-key-32-chars-l!',
                BLIND_INDEX_PEPPER: 'pepper-must-be-32-chars-long-one!',
                API_KEY_SECRET: 'test-api-secret-key-32-chars-!!!!',
            });
        ...
        it('should throw in production if key contains forbidden pattern "password"', () => {
            const config = createMockConfig({
                NODE_ENV: 'production',
                ENCRYPTION_MASTER_KEY: 'password-encryption-key-32-chars!',
                BLIND_INDEX_PEPPER: 'pepper-must-be-32-chars-long-one!',
                API_KEY_SECRET: 'test-api-secret-key-32-chars-!!!!',
            });
        ...
        it('should throw in production if key lacks uppercase', () => {
            const config = createMockConfig({
                NODE_ENV: 'production',
                ENCRYPTION_MASTER_KEY: 'alllowercase123!@#longenoughstr!!',
                BLIND_INDEX_PEPPER: 'pepper-must-be-32-chars-long-one!',
                API_KEY_SECRET: 'test-api-secret-key-32-chars-!!!!',
            });
        ...
        it('should throw in production if key lacks lowercase', () => {
            const config = createMockConfig({
                NODE_ENV: 'production',
                ENCRYPTION_MASTER_KEY: 'ALLUPPERCASE123!@#LONGENOUGHSTR!!',
                BLIND_INDEX_PEPPER: 'pepper-must-be-32-chars-long-one!',
                API_KEY_SECRET: 'test-api-secret-key-32-chars-!!!!',
            });
        ...
        it('should throw in production if key lacks number', () => {
            const config = createMockConfig({
                NODE_ENV: 'production',
                ENCRYPTION_MASTER_KEY: 'NoNumbersHere!@#LongEnoughStr!!!Abc',
                BLIND_INDEX_PEPPER: 'pepper-must-be-32-chars-long-one!',
                API_KEY_SECRET: 'test-api-secret-key-32-chars-!!!!',
            });
        ...
        it('should throw in production if key lacks special character', () => {
            const config = createMockConfig({
                NODE_ENV: 'production',
                ENCRYPTION_MASTER_KEY: 'MasterPassWithoutSpecialCharsLongEnough',
                BLIND_INDEX_PEPPER: 'pepper-must-be-32-chars-long-one!',
                API_KEY_SECRET: 'test-api-secret-key-32-chars-!!!!',
            });
        ...
        it('should throw in production if key has insufficient entropy', () => {
            const config = createMockConfig({
                NODE_ENV: 'production',
                ENCRYPTION_MASTER_KEY: 'AAAAaaaa1111!!!!AAAAaaaa1111!!!!',
                BLIND_INDEX_PEPPER: 'pepper-must-be-32-chars-long-one!',
                API_KEY_SECRET: 'test-api-secret-key-32-chars-!!!!',
            });
    ...
    describe('hashApiKey method', () => {
        ...
        it('should throw in production without API_KEY_SECRET', () => {
            ...
            expect(() => prodService.hashApiKey('key'))
                .toThrow('S1 Violation: API_KEY_SECRET is required in production');
        });
    });
    ...
    describe('hashSensitiveData method (Blind Index)', () => {
        ...
        it('should throw in production without BLIND_INDEX_PEPPER', () => {
            ...
            const prodService = new JSEncryptionService(prodConfig);
            expect(() => prodService.hashSensitiveData('test'))
                .toThrow('S1 Violation: BLIND_INDEX_PEPPER is required in production');
        });
    });
...
describe('Key Rotation Support', () => {
    it('should support re-encryption with new key', () => {
        ...
        expect(() => jsDecrypt(encryptedWithNew, oldKey, undefined))
            .toThrow('S7 Violation');
    });
...
describe('Security Boundary Tests', () => {
    ...
    describe('S7 Violation - Tamper Detection', () => {
        it('should detect ciphertext modification', () => {
            ...
            expect(() => jsDecrypt(tampered, masterKey, undefined))
                .toThrow('S7 Violation');
        });
    ...
    describe('Key Validation', () => {
        it('should reject keys shorter than 32 characters', () => {
            ...
            expect(() => jsDecrypt(encrypted, shortKey, undefined))
                .toThrow();
        });
