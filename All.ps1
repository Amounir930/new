...
$AllowedExtensions = "\.(ts|js|html|css|scss|java|py|cs|cpp|h|sql|prisma|sh|yml|yaml|xml|razor|jsx|tsx|vue|go|rs|php|rb|kt|swift|m|scala|r|pl|lua|dockerfile|gitignore|md|json)$"
